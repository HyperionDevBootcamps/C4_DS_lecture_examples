...
print("-------------End of Complaints similarity---------------")

# Lemmatization, stop words, entity recognition
nlp = spacy.load("en_core_web_sm")

doc = nlp("The ABC company is looking to invest $1 million towards funding for the XYZ project.")
...
filtered_text = ' '.join(token.text for token in doc if not token.is_stop) #dilemeter.join(iterable)
